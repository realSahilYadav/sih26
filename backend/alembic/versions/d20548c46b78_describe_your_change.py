...
Revision ID: d20548c46b78
Revises: 0003_extend_triage_records
Create Date: 2026-09-15 17:11:00.790140
...
revision: str = 'd20548c46b78'
down_revision: Union[str, None] = '0003_extend_triage_records'
...
def upgrade() -> None:
    ...
    op.alter_column('medicine_stock', 'updated_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               type_=sa.DateTime(),
               existing_nullable=False,
               existing_server_default=sa.text('now()'))
    ...
    op.alter_column('referrals', 'updated_at',
               ...
               existing_nullable=False,
               existing_server_default=sa.text('now()'))
    op.alter_column('triage_records', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               type_=sa.DateTime(),
               existing_nullable=False,
               existing_server_default=sa.text('now()'))
    op.alter_column('users', 'created_at',
               ...
               existing_nullable=False,
               existing_server_default=sa.text('now()'))
    op.drop_constraint('users_abha_id_key', 'users', type_='unique')
    op.drop_index('ix_users_abha_id', table_name='users')
...
def downgrade() -> None:
    ...
    op.create_index('ix_users_abha_id', 'users', ['abha_id'], unique=False)
    op.create_unique_constraint('users_abha_id_key', 'users', ['abha_id'], postgresql_nulls_not_distinct=False)
    op.alter_column('users', 'created_at',
